    ...
    <form class="mt-8 space-y-6" @submit="register">
        <div class="rounded-md shadow-sm -space-y-px">
            <div>
                ...
                <input id="full-name" name="fullname" type="text" autocomplete="Full name" required="" v-model="user.name"
            ...
            <div>
                ...
                <input id="password_confirmation" name="password" type="password" autocomplete="current-password" v-model="user.password_confirmation"
                    required=""
